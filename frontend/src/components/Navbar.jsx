    ...
    <header className='fixed top-0 left-0 w-full bg-gray-900 bg-opacity-90 backdrop-blur-md shadow-lg z-40 transition-all duration-300 border-b border-blue-800'>
        <div className='container mx-auto px-4 py-3'>
            ...
            <nav className='flex flex-wrap items-center gap-4'>
                <Link to={"/"} className='text-gray-300 hover:text-blue-400 transition duration-300 ease-in-out'>
                    Home
                </Link>
                {user && (
                    <Link to={"/cart"} className="relative group text-gray-300 hover:text-blue-400 transition duration-300 ease-in-out">
                ...
                {isAdmin && (
                    <Link className="bg-blue-700 hover:bg-blue-600 text-white px-3 py-1 rounded-md font-medium
                ...
                {user ? (
                    ...
                    <>
                        <Link to={"/signup"} className='bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 
						rounded-md flex items-center transition duration-300 ease-in-out'>
